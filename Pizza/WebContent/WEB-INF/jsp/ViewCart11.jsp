...
<body background="images/pic-1.jpg">
		...
		<display:table class="table table-striped" name="list" pagesize="2" requestURI="ViewCart.htm"
                ...
                <display:column class="info" property="quantity" title="quantity"
                                sortable="true" headerClass="sortable" ><form:input type="text" path="quantity" /></display:column>                
                <display:column class="info" property="cartID" title="cartID"
                                sortable="true" headerClass="sortable" />
                <display:column class="info" property="cost" title="cost"
                                sortable="true" headerClass="sortable" />  
               ...
               <display:column class="success" title="Modify" > <a href="" onclick="selectobjID">Edit</a>  </display:column> 
               <display:column class="danger" title="Delete" > <a href="" onclick="selectobjID">Delete</a>  </display:column>                                                                        
            </display:table> 
